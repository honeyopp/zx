<?php  include "../public/common/config.php";
  ...
  foreach($arr as $key=>$value){
      ...
      // print_r($path);
      $npath="$path".$value[img];
      // echo "$npath";
      $a[]=$npath;
  }

?>
<script>var width, height;var context, image, functionId;var drawLeft, drawWidth;var drawTop, drawHeight;var spaceWidth, spaceHeight;var speed=5000;var images =[<?php foreach ($a as $key => $value) {if(end($a)==$value){echo "\"$value\"";}else{echo "\"$value\"";echo ",";}}?>];function selectFrom(iFirstValue, iLastValue) {
